...
pHash + vectorized Hamming-distance comparison, reading Sample.source_path
from the Manifest. The threshold is never a bare constant: it is spec
§5.3's default, overridable via config["hamming_threshold"], and the
value actually used is always recorded on the result (spec §4 —
reproducibility).
"""
