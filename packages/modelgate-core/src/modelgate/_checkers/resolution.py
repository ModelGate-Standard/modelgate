...
Unlike the four MGS-000x checkers, this one does not return a
RequirementResult — there is no defensible threshold to attach a
PASS/FAIL verdict to yet (see spec §5.5 for why). Its output goes into
Report.informative instead.
"""
