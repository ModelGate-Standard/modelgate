...
def build_layout_variants() -> None:
    ...
    detection works identically regardless of packaging, and that
    equivalent Manifests hash identically (see ARCHITECTURE.md)."""
    ...
    # A plain-directory (ImageFolder) fixture, same content as the
    # flat-class ZIP above (same seeds -> same bytes) —
