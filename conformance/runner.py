...
def main() -> int:
    ...
    # Fixtures are either a .zip file or a directory — ImageFolderReader
    # gets exercised through the same corpus as ZipReader, not left
    # untested next to it. generate.py itself lives in this directory
    # too and is deliberately excluded.
